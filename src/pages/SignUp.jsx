...
function SignupPage() {
  ...
  return (
    <div className="relative z-[999] min-h-screen w-full py-2 sm:py-8 md:py-10 my-auto md:my-20 px-2 sm:px-6 flex flex-col lg:flex-row items-center lg:items-start justify-center bg-white">
      ...
      <div className="max-w-7xl mx-auto flex flex-wrap items-center justify-between w-full relative z-50">
        ...
        <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start text-center lg:text-left px-2 sm:px-12 xl:pl-24 pb-6 lg:pb-0">
        ...
        <div className="w-full lg:w-1/2 flex items-center justify-center px-4 sm:px-6 md:px-10">
