...
export default function BusinessSolution() {
  return (
    <div className="font-poppins px-auto py-16 md:py-24">
      <div className="container mx-auto max-w-7xl">
        ...
        <div className="grid md:grid-cols-3 bg-[#E2EBFC] p-auto py-4 md:p-10 rounded-[12px] gap-8">
          <FeatureCard
            icon={<img src="/public/image2.png" alt="Security" className="w-12 h-12" />}
            title="High security to protect from piracy"
            description="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy."
          />
          <FeatureCard
            icon={<img src="/public/image1.png" alt="Quality" className="w-12 h-12" />}
            title="Premium quality performance"
            description="Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy."
          />
          <FeatureCard
            icon={<img src="/public/image3.png" alt="Support" className="w-12 h-12" />}
